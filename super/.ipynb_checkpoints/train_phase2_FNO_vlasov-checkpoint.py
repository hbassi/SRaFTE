...
from train_phase1_FNO_2d_vlasov import FNO2dSR, SpectralConv2d
...
# PATH_STATS    = "./data/phase1_FNO_stats.pt"
# PATH_WEIGHTS  = "/pscratch/sd/h/hbassi/models/FNO_phase1_best.pth"
# SAVE_DIR      = "/pscratch/sd/h/hbassi/models"
...
PATH_STATS    = "./data/2d_vlasov_two-stream_phase1_FNO_stats.pt"
PATH_WEIGHTS  = "/pscratch/sd/h/hbassi/models/2d_vlasov_two-stream_FNO_phase1_best.pth"
SAVE_DIR      = "/pscratch/sd/h/hbassi/models"
...
def load_dataset():
    ...
    torch.save({'data_mean': data_mean, 'data_std': data_std},
               './data/2d_vlasov_fno_phase2_stats_32to128_two-stream_no_ion_v1.pt')
    ...
    for ep in trange(2001):
        ...
        #     best_val = epoch_val_loss
            torch.save(model.state_dict(),
                       os.path.join(SAVE_DIR, "FNO_phase2_best_hist_two-stream_no_ion.pth"))
            print("   ↳ saved new best")

    # ----------- save loss curves -------------------------------
    losses_path = os.path.join(SAVE_DIR, "FNO_phase2_loss_history_two-stream_no_ion.pt")
