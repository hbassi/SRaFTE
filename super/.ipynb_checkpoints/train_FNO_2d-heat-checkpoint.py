...
# ----------------------------
logging.basicConfig(
    filename='fno_training_2d-heat.log',
    level=logging.INFO,
...
def load_fine_data_both():
    ...
    fine_data = np.load("/pscratch/sd/h/hbassi/dataset/2d_heat_eqn_fine_all_smooth_gauss_1k.npy")
    # inputs, targets = [], []
...
def train_finetune():
    ...
    for epoch in trange(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model_u.state_dict(), f"/pscratch/sd/h/hbassi/FNO_fine_tuning_2d-heat_32to128_best_model.pth")
