...
# ----------------------------
logging.basicConfig(
    filename='fno_training_2d-wave.log',
    level=logging.INFO,
...
def load_fine_data_both():
    fine_data = np.load("/pscratch/sd/h/hbassi/wave_dataset_multi_sf_modes=10_kmax=7/u_fine_test.npy")
    # inputs, targets = [], []
...
def train_finetune():
    ...
    for epoch in trange(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model_u.state_dict(), f"/pscratch/sd/h/hbassi/FNO_fine_tuning_2d-wave_32to128_high-freq_best_model.pth")
