...
def cli():
    ...
    p.add_argument("--coarse", default="/pscratch/sd/h/hbassi/dataset/"
                                      "2d_heat_eqn_coarse_all_smooth_gauss_1k.npy")
    p.add_argument("--fine",   default="/pscratch/sd/h/hbassi/dataset/"
    ...
    p.add_argument("--tag",         default="heat_nuNA_gauss1k")
    return p.parse_args()
